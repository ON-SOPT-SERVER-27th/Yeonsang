...
router.post('/signup', (req, res) => {
    ...
    //7. status: 200 message: SIGN_UP_SUCCESS, data: id만 반환! (비밀번호, salt 반환 금지!!)
...
router.get('/', (req, res) => {
    ...
    const mem = usersDB;
    return res.status(statusCode.OK).send(util.success(statusCode.OK, responseMessage.MEMBER_READ_ALL_SUCCESS, mem));
})
